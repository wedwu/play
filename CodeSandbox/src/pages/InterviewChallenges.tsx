...
const CHALLENGES: Challenge[] = [
  {
    ...
    label: "Autocomplete",
    blurb:
      "Debounced typeahead with keyboard nav, async results, and ARIA combobox roles.",
  ...
  },
  {
    ...
    label: "Custom Hooks",
    blurb:
      "useDebounce + useFetch + useLocalStorage wired into a live GitHub lookup.",
  ...
  },
  {
    ...
    label: "Modal",
    blurb:
      "Portal dialog with focus trap, Escape/backdrop close, and focus restoration.",
  ...
  },
  {
    ...
    blurb:
      "One generic component renders two different element types, fully type-safe.",
    Component: GenericList,
  },
];

const InterviewChallenges = () => {
